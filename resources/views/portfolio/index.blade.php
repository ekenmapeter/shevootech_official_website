...
<head>
    ...
    <title>Our Portfolio | Shevootech Technologies Limited</title>
    <meta name="description" content="Browse our portfolio of web development, AI, graphic design, and animation projects.">
...
<body class="antialiased">
    <nav class="fixed w-full z-50 bg-white/80 backdrop-blur-md shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('portfolio.index') }}" class="text-indigo-600 px-3 py-2 font-medium">Portfolio</a>
        ...
        <div class="mobile-menu hidden md:hidden bg-white shadow-lg">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="{{ route('portfolio.index') }}" class="block px-3 py-2 text-base font-medium text-indigo-600">Portfolio</a>
    ...
    <section class="pt-32 pb-20 bg-gradient">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
            <h1 class="text-4xl md:text-5xl font-extrabold text-white">Our Portfolio</h1>
            <p class="mt-4 text-xl text-indigo-100 max-w-3xl mx-auto">See how we've helped businesses achieve their digital goals</p>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <a href="{{ route('portfolio.show', $project->slug) }}" class="project-card group block" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                    <div class="relative h-64 w-full overflow-hidden rounded-xl bg-gray-100">
                        @if(isset($project->screenshots) && count($project->screenshots) > 0)
                        <img loading="lazy" src="{{ $project->screenshots[0] }}" alt="{{ $project->title }}" class="h-full w-full object-cover object-center">
                        @else
                        ...
                        @endif
                        <div class="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                            <span class="text-white font-medium"><i class="fas fa-eye mr-2"></i>View Details</span>
                        </div>
                    </div>
                    <div class="mt-4">
                        <h3 class="text-lg font-semibold text-gray-900 group-hover:text-indigo-600 transition-colors">{{ $project->title }}</h3>
                        @if($project->client_name)
                        <p class="mt-1 text-sm text-gray-500"><i class="fas fa-user-tie mr-1"></i>{{ $project->client_name }}</p>
                        @endif
                    </div>
                </a>
                @endforeach
            ...
            <div class="text-center py-20">
                ...
                <p class="text-2xl text-gray-400">No projects in our portfolio yet.</p>
            </div>
            @endif
        </div>
    </section>
