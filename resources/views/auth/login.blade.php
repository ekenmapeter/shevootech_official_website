    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <a href="{{ url('/') }}" class="inline-flex items-center space-x-3 group">
                <img src="/images/logo.png" alt="Shevootech" class="h-10 w-auto">
                <span class="text-2xl font-bold text-white">Shevootech</span>
            </a>
        </div>
        ...
        <div class="glass rounded-2xl p-8 md:p-10">
            ...
            <a href="{{ route('auth.google') }}"
               class="btn-google w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl text-sm font-medium text-white mb-6">
            ...
            <form method="POST" action="{{ route('login') }}" class="mt-6 space-y-5">
                ...
                <div class="flex items-center justify-between">
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="remember" class="rounded border-gray-600 bg-white/5 text-indigo-500 focus:ring-indigo-500 focus:ring-offset-0">
                ...
                <button type="submit" class="btn-primary w-full py-3.5 rounded-xl text-sm font-semibold text-white">
                    Sign In
                </button>
            </form>
        ...
        <p class="text-center mt-6">
            <a href="{{ url('/') }}" class="text-sm text-gray-600 hover:text-gray-400 transition-colors">
